...
class MiniCourt():
    ...
    def convert_bounding_boxes_to_mini_court_coordinates(self,player_boxes, ball_boxes, original_court_key_points ):
        # 用 player_id 在已选球员列表中的顺序决定身高
        _chosen = list(player_boxes[0].keys())
        _heights = [constants.PLAYER_1_HEIGHT_METERS, constants.PLAYER_2_HEIGHT_METERS]
        player_heights = {pid: _heights[min(i, 1)] for i, pid in enumerate(_chosen)}

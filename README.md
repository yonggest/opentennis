...
| `models/yolo26x-seg-tuned.pt` | 球场区域分割，用于初始化单应矩阵（YOLO26x-seg fine-tuned） |
...
```bash
cp runs/segment/<run_name>/weights/best.pt models/yolo26x-seg-tuned.pt
```
